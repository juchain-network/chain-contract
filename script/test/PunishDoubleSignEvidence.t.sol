...
contract PunishDoubleSignEvidenceTest is Test, BaseSetup {
    ...
    function testSubmitDoubleSignEvidenceValid() public {
        ...
        assertEq(selfStakeAfter, selfStakeBefore - slashAmount, "selfStake should be slashed");
        assertEq(reporter.balance, reporterBalanceBefore + rewardAmount, "reporter should be rewarded");
    ...
    function _loadGoVectors() internal {
        goSigners.push(signer=0x0CA50Bf78F617bCB2D4a5ab64A70fB2E6000F340);
        goHeights.push(100);
        goHeaders1.push(
